...
#medical codes file
file_path = "input\\med_codes.xlsx" # This is the CDW. Make sure an updated version is inside the input folder
...
#Arrythmias codes
file_path_1 = "input\\arryth_codes.xlsx" #Arrythmias Codes. Make sure an updated version is in the input folder. There should be a column labeled as 'In CDW' which should be blank. 
...
output_file_path = 'output\\arry_codes.xlsx'
